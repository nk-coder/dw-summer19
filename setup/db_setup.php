<?php
	...
	//insert admin
	$insert_admin = "INSERT INTO `curious_CS`.`users`(`first_name`,`last_name`,`business_name`,`job_title`,`interested_area`, `email`, `username`, `password`, `user_type`, `registration_no`) VALUES ('Admin','admin', 'CS','Monitoring','Networking','admin@gmail.com','admin123','e10adc3949ba59abbe56e057f20f883e','1','$registration_no');";
	...
	//insert user
	$insert_user = "INSERT INTO `curious_CS`.`users`(`first_name`,`last_name`,`business_name`,`job_title`,`interested_area`, `email`, `username`, `password`, `user_type`, `registration_no`) VALUES ('John','Mike', 'CS','Monitoring','Networking','mike@gmail.com','mike123','e10adc3949ba59abbe56e057f20f883e','0','$registration_no2');";
